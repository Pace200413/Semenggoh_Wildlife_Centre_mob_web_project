...
export default function GuideProfile({ navigation, route }) {
  ...
  const userId = route.params?.userId || 3;
      ...
      <ScrollView contentContainerStyle={styles.scrollArea}>
        ...
        <View style={styles.con2}>
          ...
          {renderInfoRow("NAME", fullName, {
            screen: "NameEdit",
            params: { userId, fullName, userType: "Admin" }
          })}
          {renderInfoRow("BIRTHDAY", birthday, {
            screen: "EditBirthday",
            params: { userId, birthday, userType: "Admin" }
          })}
          ...
          {renderInfoRow("EMAIL", email, {
            screen: "EditEmail",
            params: { userId, email, userType: "Admin" }
          })}
          {renderInfoRow("PHONE", phone, {
            screen: "EditPhone",
            params: { userId, phone, userType: "Admin" }
          })}
        </View>
      </ScrollView>
    </View>
