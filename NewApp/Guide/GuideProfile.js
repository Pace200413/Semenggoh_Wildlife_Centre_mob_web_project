      ...
      <ScrollView contentContainerStyle={styles.scrollArea}>
        ...
        <View style={styles.con2}>
          ...
          {renderInfoRow("NAME", fullName, {
            screen: "NameEdit",
            params: { userId, fullName, userType: "Guide" }
          })}
          {renderInfoRow("BIRTHDAY", new Date(birthday).toLocaleDateString(), {
            screen: "EditBirthday",
            params: { userId, birthday, userType: "Guide" }
          })}
          ...
          {renderInfoRow("EMAIL", email, {
            screen: "EditEmail",
            params: { userId, email, userType: "Guide" }
          })}
          {renderInfoRow("PHONE", phone, {
            screen: "EditPhone",
            params: { userId, phone, userType: "Guide" }
          })}
        </View>
      </ScrollView>
    </View>
