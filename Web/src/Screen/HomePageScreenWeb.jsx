...
export default function HomePageScreenWeb() {
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.bottomNav}>
        ...
        <div style={styles.navItem} onClick={() => navigate('/Screen/InteractiveMap', { state: { userId, role } })}>
        ...
        <div style={styles.navItem} onClick={() => navigate('/Screen/LoginScreen', { state: { userId, role } })}>
